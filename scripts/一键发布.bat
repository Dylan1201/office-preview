...
REM ============================================
REM  vue3-office-preview 一键发布到 npm 官方源
REM  使用前请先在独立终端执行：
REM    npm login --registry=https://registry.npmjs.org/ --scope=@dylan1201
REM ============================================

set REGISTRY=https://registry.npmjs.org/
set PKG_DIR=%~dp0..\packages\vue-preview
set PKG_NAME=vue3-office-preview
...
if "%NPM_USER%"=="" (
    ...
    echo     npm login --registry=%REGISTRY% --scope=@dylan1201
    echo.
